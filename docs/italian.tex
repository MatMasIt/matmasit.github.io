...
\newcommand*{\SignatureAndDate}[1]{%
	\par\noindent\makebox[2.5in]{Alba \textsc{(CN)}, \dated}
	\par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.0in]{\hrulefill}%
	\par\noindent\hfill\makebox[5.43in][l]{\hspace{2cm}Luogo e data}    \makebox[2.0in][l]{#1}%
}%

\ecvname{Mattia, Mascarello}
\ecvfootername{Mattia, Mascarello}
%\ecvaddress{Via Dei Partigiani 5/2 12051, Alba(CN), Italy}
\ecvtelephone{(+39) 366 318 6421}
...
\ecvhomepage{\url{https://matmasit.github.io/mySite/}\newline\url{https://github.com/MatMasIt}}
...
\begin{document}
	...
	\begin{europecv}
		...
		\includegraphics[width=0.10\textwidth]{wlp}
		...
		\includegraphics[width=0.20\textwidth]{dromont}
		...
		\mycomment{
			...
			\ecvitem{Principali materie / abilità professionali oggetto dello studio}{Computer Science}
			\ecvitem{Nome e tipo di istituto di istruzione o formazione}{University of Turin - Computer Science Department}
			%\ecvitem{Level in national or international classification\footnote{If appropriate.}}{\ldots}
			\spacer
		}
		\includegraphics[width=0.10\textwidth]{logoUnito}
		...
		\includegraphics[width=0.10\textwidth]{logoLiceo}
	...
	\vspace{-2.5cm}
	\SignatureAndDate{\hspace{1.5cm}Nome Cognome}
